...
const ViewNewSongAdmin = ({ navigation }) => {
                ...
                {filteredSongs.map((song, index) => (
                    ...
                    <Pressable key={song.id} style={[styles.musicBox, { padding: 3 }]} onPress={() => navigation.navigate('ViewSong', { song_id: song.id })}>
                        ...
                        <View style={styles.musicdetails}>
                            ...
                            <Text style={{ textAlign: 'right', width: '100%', fontWeight: '900', fontSize: 10, color: 'rgb(208, 212, 255)' }}>{song.SongDate}</Text>
                        </View>
                    </Pressable>
...
export default ViewNewSongAdmin
